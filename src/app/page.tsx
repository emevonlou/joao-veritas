export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#08080b] text-zinc-100">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#3f2f15_0%,transparent_35%),radial-gradient(circle_at_bottom_right,#1e293b_0%,transparent_35%)]" />
	    ...
	    Per Intelligentiam ad Veritatem
          ...
          <div className="mt-12 grid gap-4 text-left md:grid-cols-3">
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
              <h2 className="font-bold text-amber-200">PDF, DOCX e ODT</h2>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
              <h2 className="font-bold text-amber-200">Resumo com IA</h2>
              <p className="mt-2 text-sm text-zinc-400">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
              <h2 className="font-bold text-amber-200">Modo jurídico</h2>
              <p className="mt-2 text-sm text-zinc-400">
